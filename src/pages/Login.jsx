...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full bg-accent-rose/20 blur-[120px] pointer-events-none mix-blend-screen" />
      <div className="absolute top-[30%] right-[20%] w-[400px] h-[400px] rounded-full bg-accent-cyan/10 blur-[100px] pointer-events-none mix-blend-screen" />

      <div className="relative z-10 w-full max-w-md glass-card p-10 rounded-[2.5rem] shadow-2xl border border-white/10 flex flex-col items-center animate-slideUp">
        {/* Interactive Mascot */}
        ...
        <form className="w-full flex flex-col gap-6" onSubmit={handleSubmit} noValidate>
          <div className="flex flex-col gap-2">
            ...
            <div className="relative group">
              <input
                ...
                className="w-full bg-surface-container/30 border border-white/10 rounded-2xl px-5 py-4 text-white font-body text-[15px] outline-none focus:border-primary/50 focus:bg-white/5 transition-all duration-300 placeholder:text-white/20"
                placeholder="••••••••"
                value={password}
          ...
          {error && <p className="font-body text-sm text-accent-rose text-center -mt-3 animate-fadeIn">{error}</p>}
