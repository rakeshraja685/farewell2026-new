...
const ASCII_ART = `
  _____  _    ___  ____  _ _ _  ____  _      _       ___  ___  ___  ____
 |  ___|/ \\  |  _ \\|  ___| | | ||  ___| |    | |     |___ \\/ _ \\|___ \\/ ___|
 | |_  / _ \\ | |_) | |_  | | | || |_  | |    | |       __) | | | |__) \\___ \\
 |  _|/ ___ \\|  _ <|  _| | |_| ||  _| | |___ | |___   / __/| |_| / __/ ___) |
 |_| /_/   \\_\\_| \\_\\|___|  \\___/ |___||_____||_____| |_____|\\___/_____|____/
`;
...
export default function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    if (input === CORRECT_PASSWORD) {
      ...
      newHistory.push("Invalid credentials. This incident will be reported.");
      newHistory.push(" ");
      setHistory(newHistory);
      setInput("");
